...
class Card extends Backend
{
    ...
    protected $multiFields = 'cardswitch';
    /**
     * Card模型对象
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax())
        {
            ...
            $map = [];
            ($compid>0)?$map['card.comp_id']=$compid:false;
    ...
    public function add()
    {
        if ($this->request->isPost()) {
            ...
            if ($params) {
                ...
                if (Db::name('card')->where(['cardnum'=>$params['cardnum'],'comp_id'=>$params['comp_id'],'dept_id'=>$params['dept_id']])->find()){
                $this->error(__('卡号已存在'));
            }
