...
class Dept extends Backend
{
    ...
    /**
     * Dept模型对象
     * @var \app\admin\model\Dept
     */
    protected $model = null;
    protected $multiFields = 'deptswitch';

    public function _initialize()
    {
        parent::_initialize();
        $this->model = new \app\admin\model\Dept;
    ...
    public function add()
    {
        if ($this->request->isPost()) {
            ...
            if ($params) {
                ...
                $map = [];
                ($compid>0)?$map['comp_id']=$compid:false;
                ($compid>0)?$params['deptswitch']=0:false;
                ((empty($params['deptjson'])))?$params['deptjson']='-':false;
