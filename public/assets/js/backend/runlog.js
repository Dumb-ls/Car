define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'runlog/index' + location.search,
                    add_url: 'runlog/add',
                    // edit_url: 'runlog/edit',
                    del_url: 'runlog/del',
                    multi_url: 'runlog/multi',
                    table: 'runlog',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'runtype', title: __('Runtype')},
                        ...
                        {field: 'runstat', title: __('Runstat')},
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'runlog/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
